...
// if you do not want use u8 string literal
...
int main(int, char**)
{
    ...
    ImFont* font = io.Fonts->AddFontFromFileTTF("./fonts/AmigaTopazTurkish.ttf", 12.0f, nullptr, icons_ranges_Turkish);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::Text("Bu satýr u8 string literal kullanmadý. Türkçe öçþiðüÖÇÞÝÐÜ");
